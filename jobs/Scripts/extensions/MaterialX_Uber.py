...
def default_settings():
    ...
    # 0 - PBR, 1 - Metalness
    nd_surfaceshader['in_uber_reflection_mode'] = 0
    ...
    nd_surfaceshader['in_uber_refraction_thin_surface'] = 0
    ...
    nd_surfaceshader['in_uber_refraction_caustics'] = 1
    ...
    # 0 - PBR, 1 - Metalness
    nd_surfaceshader['in_uber_coating_mode'] = 0
    ...
    # 0 - Singlesided, 1 - Doublesided
    nd_surfaceshader['in_uber_emission_mode'] = 0
    ...
    nd_surfaceshader['in_uber_sss_multiscatter'] = 0
